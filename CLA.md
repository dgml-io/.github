# DGML Individual Contributor License Agreement ("Agreement")

*Adapted from the [Apache Software Foundation's Individual Contributor
License Agreement, version 2.2](https://www.apache.org/licenses/icla.pdf).
The substantive terms are unchanged from the ASF's published text; the
receiving party has been changed from The Apache Software Foundation to
Docugami, Inc., and the signing mechanics have been adapted to this
project's electronic, GitHub-based sign-off process.*

Thank you for your interest in the DGML open source project. To clarify
the intellectual property license granted with Contributions from any
person or entity, Docugami, Inc. (the "Company") must have on file a
...
You sign this Agreement electronically by commenting on your pull request
with the exact phrase: **"I have read the CLA Document and I hereby sign
the CLA."** Read this document carefully before signing.
...
contrary to the public benefit of the DGML project. Except for the
...
are necessarily infringed by Your Contribution(s) alone or by combination
...
that your employer has executed a separate Corporate CLA with the
Company.
...
This is a legal contract. Please read it carefully and consult independent
legal counsel if you have questions before signing.
